...
namespace EvadePlus
{
    internal static class Utils
    {
        ...
        public static void DrawPolygon(this Geometry.Polygon polygon, System.Drawing.Color color, int lineWidth = 1)
        {
            for (var i = 0; i < polygon.Points.Count; i++)
            {
                var lineStart = polygon.Points[i];
        ...
        public static void Draw3DRect(Vector3 start, Vector3 end, float width, System.Drawing.Color color, int lineWidth = 2,
        ...
        public static void DrawPath(Vector2[] path, System.Drawing.Color color, int lineWidth = 1)
        {
